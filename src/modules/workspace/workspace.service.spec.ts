...
describe('WorkspaceService', () => {
  ...
  const mockWorkspace = { id: 'ws-id-1', type: 'PERSONAL', name: 'My Workspace', ownerUserId: 'user-id-1', status: 1 };
  const mockMembership = { id: 'member-id-1', workspaceId: 'ws-id-1', userId: 'user-id-1', roleId: 'role-id-1', status: 1, joinedAt: new Date(), workspace: mockWorkspace, role: mockRole };
