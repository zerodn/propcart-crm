        ...
        <div className="flex items-center gap-3 flex-1">
          <div
            className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
              isDangerous ? 'bg-red-100' : 'bg-[#CFAF6E]/15'
            }`}
          >
            <AlertCircle className={`h-5 w-5 ${isDangerous ? 'text-red-600' : 'text-[#CFAF6E]'}`} />
          </div>
        ...
        <>
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-2 px-4 rounded-lg text-sm font-medium text-white transition-colors disabled:opacity-50 ${
              isDangerous ? 'bg-red-600 hover:bg-red-700' : 'bg-[#CFAF6E] hover:bg-[#B89655]'
            }`}
          >
