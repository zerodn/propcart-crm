          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 text-center leading-relaxed">
                  Dự án gồm các sản phẩm nhà ở liền thổ, có chiều cao giới hạn: biệt thự, nhà phố liền kề, shophouse,...
                </p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1 text-center leading-relaxed">
                  Dự án nhà chung cư, căn hộ, văn phòng, hoặc khách sạn có số tầng lớn: căn hộ chung cư, khách sạn, officetel,...
                </p>
              </div>
            </button>
          </div>
